...
// instanceof 연산
// : 참조변수값 instsnce of 타입 (클래스명)
// >> 해당 객체가 특정 클래스의 인스턴스인지 또는 그 클래스를 상속 받은 
//	자식 클래스의 인스턴스인지를 확인

// vehicle 은 운송수단 탈 것 을 의미
class Vehicle {
	void display() {
...
public class B_Polymorphism {
	public static void main(String[] args) {
		...
		// cf) instanceof 연산자 계산식에서 true 의 결과갑이 출력되면
		// > 해당 클래스 타입으로 형 변환이 가능
		// > 형 변환 이전에는 instanceof 연산자를 통해 오류 방진
